...
/*
 * Client-side main-class to create a few instances of com.entertainment.Television
...
class TelevisionClient {
    public static void main(String[] args){
        ...
        // Create 2nd instance of com.entertainment.Television object, and turn it on
        Television tv2 = new Television("Sony", Television.MIN_VOLUME, DisplayType.LED);
        tv2.turnOn();

        // Create 3rd instance of com.entertainment.Television object, but don't set properties
