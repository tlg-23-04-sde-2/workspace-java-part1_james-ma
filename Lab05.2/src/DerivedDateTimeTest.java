...
//
import static java.time.DayOfWeek.*;    // * is OK for static import
...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate birthDate1 = valentinesDay.plusWeeks(38);
        ...
        LocalDate birthDate2 = newYearsDay.plusWeeks(38);
    ...
    public static void testLaborDay() {
        LocalDate sep1 = LocalDate.of(1990, 9, 1);
    ...
    public static void testElectionDay() {
        ...
        LocalDate electionDate = nov1.with(firstInMonth(MONDAY)).plusDays(1);
